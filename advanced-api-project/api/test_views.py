...
class BookAPITestCase(APITestCase):
    def setUp(self):
        ...
        # Create a test book
        self.book = Book.objects.create(title="First Book", author="Author Test", publication_year=2025-5-7)
    ...
    def test_create_book(self):
        ...
        data = {"title": "First Book", "author": "New Author", "publication_year": 2025-4-5}
...
class BookAPITestCase(TestCase):
    ...
    def test_create_book(self):
       # Test creating a new book via the API.
        ...
        self.assertEqual(Book.objects.last().title, "First Book")
